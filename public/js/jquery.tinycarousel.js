...
(function($) {
    ...
    function Plugin($container, options) {
        ...
        this.update = function() {
            ...
            viewportSize = $viewport[0]["offset" + sizeLabel] == 0 ? 240 : $viewport[0]["offset" + sizeLabel];
        ...
        this.move = function(index) {
            ...
            $container.siblings('.carousel-indicators').find('li:eq('+( self.slideCurrent )+')').addClass('active');
            $container.siblings('.carousel-indicators').find('li:eq('+( self.slideCurrent )+')').siblings().removeClass('active');
            _setButtons();
            self.start();
