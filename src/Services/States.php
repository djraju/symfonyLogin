...
class States
{
    public static function getStates()
    {
        ...
        $states["American Samoa"] = 'American Samoa';
        ...
        $states["District of Columbia"] = 'District of Columbia';
        ...
        $states["Northern Mariana Islands"] = 'Northern Mariana Islands';
        $states["Ohio"] = 'Ohio';
        $states["Oklahoma"] = 'Oklahoma';
        $states["Oregon"] = 'Oregon';
        $states["Pennsylvania"] = 'Pennsylvania';
        $states["Puerto Rico"] = 'Puerto Rico';
